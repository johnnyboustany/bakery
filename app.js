...
const updatePage = async () => {
  ...
  const filteredFruitsArray = fruitsArray.filter(item => {return item.nutritions.sugar > 15});
  ...
  for (let i = 0; i < filteredFruitsArray.length; i++) {

    newElement.innerHTML += filteredFruitsArray[i].name;
